...
def format_constant(
    ...
    lines = [
        ...
        "// keyed by district name. Generated by scripts/generate_state_seat_fp.py.",
        "// Use in computeModelledSeatsState() as the 'baselinePrim' parameter.",
        f"const {const_name} = {{",
    ]
...
def main() -> None:
    ...
    if args.output_module:
        ...
        # Derive the populated set from the blocks' actual export names.
